...
void initBackground(Background *background1, Background *background2) {
    background1->image = IMG_Load("/home/aziz/Desktop/Integration (copy)/ack1.png");
    background2->image = IMG_Load("/home/aziz/Desktop/Integration (copy)/ack2 (2).png");
...
void scroll(Background* back, Uint8 dx ) {
	back->camera_pos.x += dx;
	dx+=dx;
	back->camera_pos.w=SCREEN_WIDTH-dx;
}
