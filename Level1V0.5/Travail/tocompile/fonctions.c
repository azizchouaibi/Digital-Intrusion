...
SDL_Surface ** initAnimBack() {
		...
		tab[0]= IMG_Load("/home/aziz/Desktop/Travail/for ts/anim1.png");
		tab[1]=IMG_Load("/home/aziz/Desktop/Travail/for ts/anim2.png");
		tab[2]=IMG_Load("/home/aziz/Desktop/Travail/for ts/anim3.png");
